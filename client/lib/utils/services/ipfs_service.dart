  ...
  Future<String> uploadMetaData(Map<String, dynamic> body) async {
    try {
      final response = await http.post(
        ...
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweEFiNGExMDQ5YzJDNEZiMzIxREJEZjhCOEU2MDQ0OTcyZjkyZjAxNjMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTY2ODA4Nzk4MDY1MSwibmFtZSI6Ik5GVF9TVE9SQUdFX0tFWSJ9.D1SJbnuXnWyLocu_it6zr8VvrOfviQ8ITudAlhGiGT4',
